      ...
      <div className="w-full max-w-md animate-fade-in">
        ...
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-2xl bg-linear-to-br from-[#16a37a] to-[#0ba8b2] flex items-center justify-center shadow-md">
            ...
            <div>
              <h1 className="text-base font-bold text-gray-900 dark:text-white leading-tight">User Dashboard</h1>
        ...
        <div className="bg-white dark:bg-[#161b22] border border-gray-100 dark:border-white/6 rounded-2xl shadow-sm p-6">
          <div className="flex items-center gap-3 mb-5">
            {/* Avatar */}
            <div className="w-12 h-12 rounded-full bg-linear-to-br from-[#16a37a] to-[#0ba8b2] flex items-center justify-center text-white font-bold text-lg shadow">
              {user.email?.[0]?.toUpperCase() ?? "U"}
            </div>
            <div>
              <p className="text-sm font-semibold text-gray-900 dark:text-white">{user.email}</p>
              <span className="inline-flex items-center text-xs font-semibold px-2 py-0.5 rounded-full bg-[#16a37a]/10 text-[#16a37a] dark:bg-[#16a37a]/20 dark:text-[#6dd4b0] mt-0.5">
                {user.role}
              </span>
            </div>
          </div>
